...
def fetch_frame():
    ...
    # TODO-B8: Fetch JPEG bytes from HTTP_FRAME_URL with timeout handling.
    # TODO-B9: Validate status code and payload size before returning bytes.
    return None


def chunk_data(data, chunk_size):
    """Split bytes into equal chunks."""
    # TODO-B10: Split raw frame bytes into chunk list of size `chunk_size`.
    return []
...
def send_frame(sock, frame_id, frame_bytes):
    ...
    # TODO-B11: Pack each chunk header (frame_id, chunk_id, total_chunks, payload_len).
    # TODO-B12: Send packet bytes to UDP receiver address.
    # TODO-B13: Add short pacing delay to reduce burst packet loss.
...
def main():
    ...
    while True:
        ...
        # TODO-B14: Send frame and update counters (`sent_frames`, `sent_bytes`, `frame_id`).
        # Placeholder keeps the pacing loop active for student implementation.
        time.sleep(0.05)
